...
export const Navbar = () => {
    ...
    return (
        <nav className={`p-6 ${navOpen ? "w-1/5" : "w-[8%]"} items-center transition-all flex flex-col justify-between text-white border-r-[1px] border-gray-500 border-opacity-40 border-dashed`}>
            ...
            <button className='flex w-[-webkit-fill-available] justify-center items-center bg-blue-700 text-white font-semibold px-3 py-2 text-base rounded-md'>Sign Out</button>
